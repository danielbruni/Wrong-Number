...
<div class="grid grid-cols-3 grid-rows-4 gap-8">
	<div class="flex size-16 items-center justify-center text-black">
		<a
			href="https://github.com/danielbruni/Wrong-Number"
			target="_blank"
			aria-label="GitHub repository"
		>
			<svg viewBox="0 0 20 20" class="size-14 fill-black"
				><path
